...
class Constants(BaseConstants):
    ...
    time_period = settings.SESSION_CONFIGS[1].get('time_period')  # Total time allotted to a period
    time_begin = settings.SESSION_CONFIGS[1].get('time_welcome')  # Time allotted in the first page
