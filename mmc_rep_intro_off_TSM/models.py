...
doc = """
Introduction and Quiz to Multimarket Contact experiment Treatment T-MSym (Offline)
"""
...
def frame_question(choices_prob, choices_actions, choices_periods, choices_part, choices_P1, choices_P2):
    ...
    questions[6]['statement'] = models.StringField(initial="In a Period, if you choose Action W and Other chooses Action Y in Blue Game, then how many points will you receive in Blue Game? (Refer to the Points Tables above)")
...
class Constants(BaseConstants):
    name_in_url = 'mmc_rep_intro_off_TSM'
